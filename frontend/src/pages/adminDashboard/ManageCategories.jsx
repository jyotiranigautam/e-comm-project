...
const ManageCategories = () => {
    ...
    rows: [
      {
        ...
        actions: (
          <>
            <i
              className="bx bxs-edit px-1"
              style={{ fontSize: "25px", color: "#007bff", cursor: "pointer" }}
              // onClick={() => handleUpdateShow(cat.id)}
            ></i>{" "}
            <i
              className="bx bxs-message-square-x px-1"
              style={{ fontSize: "25px", color: "#dc3545", cursor: "pointer" }}
              // onClick={() => handleDeleteShow(cat.id)}
            ></i>
          </>
        ),
      },
  ...
  return (
    <>
      <div>
      <Navbartwo />
        <div className="dashboard admin-background px-0" >
            ...
            <div className="dashboard-content" style={{ paddingLeft: '0' }}>
              ...
              <div className="px-5">
                <div className='d-flex mt-50  align-items-center justify-content-between '>
                  <Breadcrumbs pageName='Manage Categories' />
                  <div>
                    <a href='/add-category'>
