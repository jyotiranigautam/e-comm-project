    ...
    <>
      ...
      <section className='promotion-video mt-100'>
        <div className="wrapper container">
          ...
          <div className="video-container mt-5 mx-5 px-5">
      ...
      <section className='testimonials mt-100'>
        <div className="container ">
          <div className="testimonial-content mx-5">
            ...
            <div className="client-testimonials text-center">
              <Slider {...testimonials} className='px-5 mx-5 mt-5'>
                <div>
